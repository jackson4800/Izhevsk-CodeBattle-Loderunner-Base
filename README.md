...
2. Черный экран. Скорее всего, не удалось подключиться к серверу.
3. Ошибки при компиляции. Скорее всего, вы собираете проект как приложение Win32, он настроен лишь для 64-ти битных систем, настройте под 32 ручками.
